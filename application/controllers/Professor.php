    ...
    public function disciplinas($id, $json=TRUE) {
		...
		public function disponibilidade(){
	        ...
	        $this->load->view('disponibilidade/js_disponibilidades');
					...
					if ($this->Disponibilidade_model->verificaHorasDia($disponibilidade['dia'])) {
						...
						$this->session->set_flashdata('danger','Não foi possível cadastrar a disponibilidade, superou a quantidade maxima de aulas diarias.');
						redirect('Professor/disponibilidade');
					}
				}
