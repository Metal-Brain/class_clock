<div class="col-xs-12 col-sm-12 col-md-10 col-lg-10">
	...
	<form class="formPeriodos" method="post" action="<?= site_url('periodo/atualizar/'.$periodo->id)?>">
		<div class="form-group width-400">
			...
			<input id="nome_editar" name="nome" class="form-control" type="text" placeholder="xxxx-x" onkeyup="mascara(this,somenteNumeros);" value="<?= htmlspecialchars($periodo->nome) ?>" maxlength="5">
			<?= form_error('nome') ?>
		</div>
